...
export default function Skills(skillsTakenArray, handleUpdateSkillsTakenArray) {
    ...
    const skillList = skillsTakenArray.sort(function(a, b) {
        if(a.toLowerCase() < b.toLowerCase()) return -1;
        if(a.toLowerCase() > b.toLowerCase()) return 1;
        return 0;
    }).map((skillsTakenArray) => 
